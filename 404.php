...
<?php
  $title = "{$noti->titleNoti()} whoops! Error • Stomigram";
  $keywords = "eror, 404, document not found, webpage not found, Stomigram, experience and share new lifestyle on Ratemo Universe";
