...
<div class="senapati pro_senapati grp_senapati a_m_senapti">
  ...
  <?php if ($groups->isGrpAdmin($grp, $session) == false){
    echo "<div class='home_last_mssg add_mem_last_mssg'><img src='". DIR ."/images/needs/st3.jpg'><span>You're not the admin of this group to add members.</span></div>";
  } else { ?>
  ...
  <div class="srajkumar grp_srajkumar">
    ...
    <div class="sabout inst">
      <div class="sabout_one">
        <img src="<?php echo DIR; ?>/images/needs/st3.jpg" alt="">
