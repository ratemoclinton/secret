<?php
  class editProfile{
    ...
    public function resend_vl(){
      ...
      $mail->FromName = "Team Stomigram";
      $mail->addAddress($clintonrucy@gmail.com);               // Name is optional
      $mail->addReplyTo($this->clintonrucy@gmail.com, 'Team Stomigram');
      ...
      $mail->Subject = 'Verify your Stomigram account';

      $mail->Body = "<span>Hello, You received this message because you created an account on STOMIGRAM.<span><br>
      <span>Click on button below to verify your Stomigram account and explore.</span><br><br>
