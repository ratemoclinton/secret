  ...
  class forgot{
    ...
    public function retrieve($input){
      ...
      if ($scount == 0) {
        ...
        $mail->setFrom($this->gmail, 'Team Stomigram');
        $mail->addAddress($email);               // Name is optional
        $mail->addReplyTo($this->gmail, 'Team Stomigram');
        ...
        $mail->Subject = 'Activate your Stomigram account';

        $mail->Body = "<span>Hello, You received this message because you created an account on STOMIGRAM.<span><br>
        <span>Click on button below to retrieve your Stomigram account and explore.</span><br><br>
