...
<?php
  $title = "{$noti->titleNoti()} {$groups->GETgrp($grp, 'grp_name')} • Stomigram";
  $keywords = "Stomigram, Share and capture world's moments";
  $desc = "View group • Stomigram";
?>
...
<div class="badshah">
  ...
  <?php if($groups->memberOrNot($grp, $session) == false && $groups->GETgrp($grp, "grp_privacy") == "private"){ ?>
    ...
    <div class='home_last_mssg grp_last_mssg'><img src='<?php echo DIR; ?>/images/needs/empty_screen_face-905ec56ff4d5ef0004450379807fd170.gif'>
  ...
  <?php } else if($universal->isLoggedIn() == false) { ?>
    ...
    <div class='home_last_mssg grp_logout_last_mssg'><img src='<?php echo DIR; ?>/images/needs/empty_screen_face-905ec56ff4d5ef0004450379807fd170.gif'>
