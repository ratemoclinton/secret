...
<div class="container login_container">
  ...
  <div class="log_sign">
    <a href="signup" class="pri_btn">Create an Account</a>
  </div>
   <div class="banner">
   ...
   <div class="banner">
    <img src="<?php echo DIR; ?>/images/needs/rat1.PNG" alt="">
    <!-- <img src="http://chicohq.com/images/bg.svg" alt=""> -->
  </div>

  <div class="input_wrapper">
    <div class="display_text">
      <span>First account to reach 1000 posts with at least 3 likes per post stands chance to win a full week trip package to Dubai..</span>
    </div>
    <div class="sign_up_div">
      <form class="login" action="" method="post">
        ...
        <div class="username_checker u_c">
          <span class="checker_text">username already taken</span>
  ...
  <div class="q_l_model">
    ...
    <div class="q_l_m_main">
      <div class="q_l_m_img_div">
        ...
        <span class="q_l_username">Clinton Ratemo</span>
      </div>
