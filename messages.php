...
<?php
  $title = "{$noti->titleNoti()} Messages • Stomigram";
  $keywords = "Stomigram, Share and capture world's moments, share, capture, messages";
...
<script type="text/javascript">
  $(function(e){
    ...
    //       var n = new Notification('Stomigram', {
    //         body: "Welcome to Stomigram!",
