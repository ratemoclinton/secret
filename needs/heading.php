<body>
  <div class="header">
    <div class="logo">
      <a href="<?php echo DIR; ?>"><img src="<?php echo DIR; ?>/images/needs/sto.PNG" alt="Stomigram"></a>
    </div>
    <div class="search_box">
      <?php if($universal->isLoggedIn()){ ?>
      <input type="text" name="" placeholder="Search Stomigram" spellcheck="false" autocomplete="off" class="search" autofocus>
