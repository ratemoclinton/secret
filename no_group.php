...
<?php
  $title = "{$noti->titleNoti()} Group not found • Stomigram";
  $keywords = "eror, 404, document not found, webpage not found, Stomigram, Share and capture world's moments";
  $desc = "There's been an error • Stomigram";
?>
...
<div class="badshah">
  <div class="err">
    ...
    <img src="<?php echo DIR; ?>/images/needs/st2.jpg" alt="404">
    <?php
      if ($universal->isLoggedIn()) {
    ?>
