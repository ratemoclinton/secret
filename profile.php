...
<?php
  $title = "{$noti->titleNoti()} @{$universal->GETsDetails($get_id, "username")} ({$universal->GETsDetails($get_id, "firstname")} {$universal->GETsDetails($get_id, "surname")}) • Stomigram";
  $keywords = "{$universal->GETsDetails($get_id, "username")}, {$universal->GETsDetails($get_id, "firstname")}, {$universal->GETsDetails($get_id, "surname")}, Stomigram, Share and capture world's moments";
  $desc = "Connect with {$universal->GETsDetails($get_id, "username")}'s profile • Stomigram";
?>
...
<div class="badshah">
  ...
  <?php
    if($universal->isLoggedIn() == false){
      echo "<div class='home_last_mssg private_last_mssg'><img src='". DIR ."/images/needs/st.jpg'>
      ...
      echo "<div class='home_last_mssg private_last_mssg'><img src='". DIR ."/images/needs/st1.jpg'>
