...
<div class="container">
  ...
  <div class="log_sign">
   ...
   <div class="banner">
    <img src="<?php echo DIR; ?>/images/needs/st2.jpg" alt="">
  ...
  <div class="input_wrapper">
    ...
    <div class="sign_up_div">
      <form class="sign_up" id="sign_up" action="" method="post">
        ...
        <label for="s_terms" class="terms">I agree to <a href="terms" class="a_pri">Stomigram Terms</a></label>
