...
<?php
  $title = "{$noti->titleNoti()} Post by {$universal->GETsDetails($post_by, "username")} • Stomigram";
  $keywords = "Stomigram, Share and capture world's moments, share, capture, view post";
